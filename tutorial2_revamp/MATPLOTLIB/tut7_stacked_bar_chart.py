...
if i==0:
    ...
    plt.bar(mid_vals-bar_width*0.0,  count1,  bottom=count3, width=bar_width,  facecolor='chocolate',  label='sample bar1',  yerr=errors)
    ...
    plt.bar(mid_vals+bar_width*0.0,  count4,  bottom=count3+count1,  width=bar_width,  facecolor='green',  label='sample bar4',  yerr=errors)
